...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
    ...
    { 
        ...
        $renderer->setViewScriptPathNoControllerSpec(':device/:action.:suffix');
        $renderer->setViewScriptPathSpec(':device/:controller/:action.:suffix');

        if (!Globals::isMobile()) {
            $renderer->getInflector()->setStaticRule('device', 'pc');
        } else {
            $renderer->getInflector()->setStaticRule('device', 'sp');
        }        
    }
