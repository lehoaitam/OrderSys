...
class Application_Model_SubComment extends Application_Model_Entity
{
    const MAIN_FILE     = 'subcomment.csv';
    const API_LIST_METHOD = 'getSubcommentList';
    ...
    public function getDataSubCommentFillCombobox()
    {
        ...
        foreach ($data as $key => $item) {
            ...
            // End 2013/08/28
			//edit by ngqtrung 2014/05/20
            $dataCombox[$key] = $item->getGuidance();
			//end edit
         }
